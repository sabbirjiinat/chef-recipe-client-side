    ...
    return (
        <footer className='bg-gray-800 mt-5 text-white md:p-10'>
            ...
            <div>
                ...
                <p className='my-3 text-gray-300 text-sm'>A chef is a professional  cook and <br /> tradesman who is proficient in all <br /> aspects  of food preparation.</p>
            <img className='my-3 w-36 cursor-pointer' src='https://i.ibb.co/M2YbMKN/Group9969.png' alt="" />
            </div>
            <div>
            ...
            <div>
                ...
                <p className='my-2 text-gray-300  md:text-sm'>Midori Japanese Restaurant</p>
                <p className='my-2 text-gray-300  md:text-sm'>Izumi Japanese Kitchen</p>
                <p className='my-2 text-gray-300  md:text-sm'>Sumo Sushi Restaurant</p>
