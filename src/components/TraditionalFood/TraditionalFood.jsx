    ...
    return (
        ...
        <div className="card-body pt-1 pl-1">
          ...
          <div className="card-actions justify-end">
            <button className="bg-sky-600 px-2 py-1 rounded-sm text-xl hover:bg-sky-800 hover:text-white duration-300 font-semibold">Place Order</button>
          </div>
        </div>
      </div>
    );
