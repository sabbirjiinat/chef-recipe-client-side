...
const Chef = ({ chef }) => {
    ...
    return (
        ...
        <div className="card-body">
          ...
          <div className=" ">
            <Link to={`/chef/${id}`} className="bg-blue-400 text-base hover:bg-blue-600 duration-300 hover:text-white block text-center rounded-sm w-full px-3 py-1 font-semibold ">View Recipes</Link>
          </div>
        </div>
      </div>
